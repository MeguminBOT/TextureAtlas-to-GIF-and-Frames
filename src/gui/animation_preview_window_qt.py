...
"""
Qt-based Animation Preview Window
Replaces the tkinter-based animation_preview_window.py
"""
...
class AnimationPreviewWindow(QDialog):
    ...
    This window allows users to preview GIF and WebP animations with controls for
