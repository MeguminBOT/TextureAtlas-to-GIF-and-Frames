...
"""
Qt-based Contributors Window
Replaces the tkinter-based contributors_window.py with a PySide6 implementation.
"""
...
class ContributorsWindow(QDialog):
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = QLabel("TextureAtlas to GIF and Frames\nContributors")
    ...
    def add_contributors(self, layout):
        ...
        # You can customize this section based on your actual contributors
        contributors_data = [
            {
                "name": "MeguminBOT",
                "role": "Lead Developer",
            ...
            # Add more contributors here as needed. To add: Jsfasdf250 and Julnz
        ]
