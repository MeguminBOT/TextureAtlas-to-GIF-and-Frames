...
"""
Qt-based Override Settings Window
Replaces the tkinter-based override_settings_window.py
"""
        ...
        if self.app and hasattr(self.app, "show_animation_preview_window"):
            try:
                ...
                AnimationPreviewWindow.preview(
                    ...
                    self.indices_edit,
                    self.frames_edit if hasattr(self, "frames_edit") else None,
                )
