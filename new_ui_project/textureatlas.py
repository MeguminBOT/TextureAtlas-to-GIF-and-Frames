...
from PySide6.QtWidgets import QAbstractItemView, QApplication, QCheckBox, QDoubleSpinBox, QGroupBox, QLabel, QLineEdit, QListView, QMainWindow, QProgressBar, QPushButton, QSizePolicy, QSpinBox, QStatusBar, QTabWidget, QWidget
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"E:/GitHub/TextureAtlas-to-GIF-and-Frames/icon.ico", QSize(), QIcon.Normal, QIcon.Off)
