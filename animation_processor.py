...
class AnimationProcessor:
    ...
    def save_frames(self, image_tuples, kept_frame_indices, spritesheet_name, animation_name, scale):
        ...
        for index, frame in enumerate(image_tuples):
            if index in kept_frame_indices:
                formatted_frame_name = self.format_filename(self.prefix, spritesheet_name, frame[0], self.filename_format)
    ...
    def save_webp(self, images, spritesheet_name, animation_name, fps, delay, period, scale):
        ...
        formatted_webp_name = self.format_filename(self.prefix, spritesheet_name, animation_name, self.filename_format)
    ...
    def save_gif(self, images, spritesheet_name, animation_name, fps, delay, period, scale, threshold, max_size, image_tuples, current_version):
        ...
        formatted_gif_name = self.format_filename(self.prefix, spritesheet_name, animation_name, self.filename_format)
    ...
    def format_filename(self, prefix, sprite_name, animation_name, filename_format):
