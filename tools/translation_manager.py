...
"""
Translation management utility for TextureAtlas Toolbox.

This script helps with generating and updating translation files.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Translation management for TextureAtlas Toolbox")
    parser.add_argument(
        "command",
